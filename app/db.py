...
_ADDITIVE_STATEMENTS = (
    ...
    # 0.7.0: syslog carries only >= this severity (journal keeps everything)
    "ALTER TABLE settings ADD COLUMN IF NOT EXISTS syslog_min_level TEXT NOT NULL DEFAULT 'WARNING'",
)
